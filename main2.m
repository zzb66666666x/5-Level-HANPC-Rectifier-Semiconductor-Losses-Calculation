...
for i=1:1:1
    ...
    for f_switch=900:50:3600%Hz
        for I_amplitude=1:-0.1:0.2%Percentage
            [N_num1,N_num2,Po,P_S_switch_25,P_S_conduct_25,Eta_25,Alpha]=calculation2(f_switch,I_amplitude,Po,switch_voltage(i),I_step,Lo);%Angle is converted to radian
