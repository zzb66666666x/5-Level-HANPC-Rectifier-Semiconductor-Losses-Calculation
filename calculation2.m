function [N_num1,N_num2,Po,P_S_switch_25,P_S_conduct_25,Eta_25,Alpha] = calculation2(f_switch,I_amplitude,Po,switch_voltage,I_step,Lo)
% This is a function for calculating the loss.
% We choose to use the SI units.o
